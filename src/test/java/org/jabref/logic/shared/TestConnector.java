...
public class TestConnector {
    ...
    public static DBMSConnectionProperties getTestConnectionProperties(DBMSType dbmsType) {
        switch (dbmsType) {
            ...
            case ORACLE:
                return new DBMSConnectionPropertiesBuilder().setType(dbmsType).setHost("localhost").setPort(dbmsType.getDefaultPort()).setDatabase("XE").setUser("sysdba").setPassword("").setUseSSL(false).setPort(32118).createDBMSConnectionProperties();
            default:
